  ...
  return (
    <section className="h-screen flex flex-col items-center justify-center bg-gray-50 text-center px-6">
      ...
      <h2 className="text-2xl font-semibold mb-2">You’ve gone off the map 🗺️</h2>
        ...
        <Link
          href="/"
          className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
