  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold mb-6">About Kaalamithra AI Tech Solutions</h1>
        <p className="text-gray-700 text-lg mb-4">
          We are a technology company focused on delivering AI-driven, scalable solutions
